...
public class Constantes {
    ...
    public static final String ERRO_CRIACAO_SUBCONTA = "Ocorreu um erro no processo de criação da subconta da empresa: ";
    public static final String ERRO_CONSULTA_SUBCONTA_TESTES = "Ocorreu um erro no processo de consulta da subconta de testes: ";
    ...
    public static final List<FormaPagamentoEnum> formasPagamentoAsaas = new ArrayList<>(
            Arrays.asList(FormaPagamentoEnum.BOLETO, FormaPagamentoEnum.PIX, FormaPagamentoEnum.CREDIT_CARD)
    );
