...
@Slf4j
@Service
public class ClienteAsaasService {

    @Autowired
    AsaasProxy asaasProxy;

    protected String realizaCriacaoClienteAsaas(ClienteRequest clienteRequest, Long idEmpresaLogada) {
        ...
        try {
            ...
            responseAsaas =
                    asaasProxy.cadastraNovoCliente(criaClienteAsaasRequest, System.getenv(Constantes.TOKEN_ASAAS));
        } catch (Exception e) {
    ...
    protected void realizaRemocaoDoClienteNaIntegradoraAsaas(ClienteEntity cliente) {
        ...
        try {
            ...
            responseAsaas =
                    asaasProxy.removerCliente(cliente.getAsaasId(), System.getenv(Constantes.TOKEN_ASAAS));
        } catch (Exception e) {
    ...
    protected void realizaAtualizacaoClienteAsaas(String asaasId, ClienteRequest clienteRequest, Long idEmpresaLogada) {
        ...
        try {
            ...
            responseAsaas =
                    asaasProxy.atualizaCliente(asaasId, criaClienteAsaasRequest, System.getenv(Constantes.TOKEN_ASAAS));
        } catch (Exception e) {
