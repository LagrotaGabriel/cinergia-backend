...
public class EmpresaEntity {
    ...
    @Column(name = "COD_EMPRESA_EMP", nullable = false, unique = true, updatable = false, length = 36)
    private UUID uuid;
    ...
    @Column(name = "EML_EMAIL_EMP", nullable = false, unique = true, length = 70)
    private String email;

    @Comment("CPF ou CNPJ da empresa. Caso a empresa não possua um CNPJ, é possível se cadastrar utilizando o CPF")
    @Column(name = "CDP_CPFCNPJ_EMP", nullable = false, unique = true, length = 18)
    ...
    @Column(name = "INE_INSCRICAOESTADUAL_EMP", length = 15)
    ...
    @Column(name = "COD_ENDERECO_EMP", nullable = false)
    ...
    @Column(name = "COD_TELEFONE_EMP", nullable = false)
    ...
    @Column(name = "COD_ACESSO_EMP", nullable = false)
    ...
    @Column(name = "LST_CLIENTES_EMP", nullable = false)
    ...
    @Column(name = "LST_TRANSFERENCIAS_EMP", nullable = false)
    ...
    @Column(name = "LST_NOTIFICACOES_EMP", nullable = false)
