...
class CartaoEntityTest {
    ...
    void deveTestarDataBuilder() {
        Assertions.assertEquals(
                "CartaoEntity(id=1, dataCadastro=2023-06-02, horaCadastro=10:29, nomePortador=Gabriel, " +
                        "cpfCnpjPortador=47153427821, numero=5162306219378829, ccv=318, mesExpiracao=8, " +
                        "anoExpiracao=2025, tokenCartao=null, bandeiraCartaoEnum=VISA, exclusao=null)",
    ...
    void deveTestarAllArgsConstructor() {
        ...
        Assertions.assertEquals(
                "CartaoEntity(id=1, dataCadastro=2023-06-02, horaCadastro=10:48, nomePortador=Fulano, " +
                        "cpfCnpjPortador=12345678910, numero=5162306219378829, ccv=315, mesExpiracao=4, " +
    ...
    void deveTestarBuilder() {
        ...
        Assertions.assertEquals(
                "CartaoEntity(id=1, dataCadastro=2023-06-02, horaCadastro=10:48, nomePortador=Fulano, " +
                        "cpfCnpjPortador=12345678910, numero=5162306219378829, ccv=310, mesExpiracao=2, " +
